...
namespace Blogs.Services
{
    ...
    public class MongoDbBlogService : IBlogService
    {
        private  List<Post>  _cache = new List<Post>();
        private readonly IMongoCollection<Post> _posts;
        private IHttpContextAccessor _contextAccessor;

        // public MongoDbBlogService(IHostingEnvironment env, IHttpContextAccessor contextAccessor)
        // {
        ...
        // }
         public MongoDbBlogService(IHostingEnvironment env, IHttpContextAccessor contextAccessor)
        {
            IPostsDatabaseSettings settings = new PostsDatabaseSettings();
        ...
        private void LoadPosts()
        {
            ...
            foreach (var cachePost in _posts.AsQueryable())
            {
                Post post = new Post()
                {
                    ID = cachePost.ID,
                    Title = cachePost.Title,
                    Excerpt =cachePost.Excerpt,
                    Content = cachePost.Content,
                    Slug = cachePost.Slug.ToLowerInvariant(),
